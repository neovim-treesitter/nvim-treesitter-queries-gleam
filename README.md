# nvim-treesitter-queries-gleam

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-gleam/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-gleam/actions/workflows/validate.yml)

Neovim tree-sitter queries for **gleam**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-gleam",
...
- [ ] Changes are scoped to `gleam` — do not include files for other languages
